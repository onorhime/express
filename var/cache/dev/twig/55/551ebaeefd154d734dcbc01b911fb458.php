...
class __TwigTemplate_08e80ac5086ff317c6f08dc93c6681cd extends Template
{
    private $source;
    private $macros = [];
                            ...
                            <ul class=\"options2 d-block text-decoration-none\">
                                <li class=\"mb-3 option2 d-lg-flex justify-content-between align-items-center border border-primary\"
                                    ...
                                    <span class=\"fs-3 font-weight-bold\">
                                        \$";
        // line 70
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 70, $this->source); })()), "user", [], "any", false, false, false, 70), "balance", [], "any", false, false, false, 70), 2, ".", ","), "html", null, true);
        echo "</span>
                                </li>
                            </ul>
                        </div>
    ...
    <script src=";
        // line 137
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("customs/js/invest.js"), "html", null, true);
        echo "></script>
";
    ...
    {
        return array (  206 => 137,  136 => 70,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}", "dashboard/invest.html.twig", "C:\\xampp\\htdocs\\express\\templates\\dashboard\\invest.html.twig");
    }
}
